            ...
            {!chatStarted && (
              <div id="intro" className="mt-[16vh] max-w-chat mx-auto text-center px-4 lg:px-0">
                ...
                <p className="text-md lg:text-xl mb-8 text-bolt-elements-textSecondary animate-fade-in animation-delay-200">
                  Developed By <a href="https://wa.me/8801751465955?text=Hey%20Sharan%20Sifat,%20I%20come%20from%20BAUST%20DEV" target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:text-blue-600">Sharan Sifat</a>
                </p>
              </div>
            )}
            <div
                ...
                >
                  ...
                  >
                    <textarea
                      ...
                      placeholder="How can BAUST DEV help you today?"
                      translate="no"
                    />
                    <ClientOnly>
                      {() => (
